...
// 1. Change the text for the h1 element to something (anything!) else.
let h4El = document.querySelectorAll("h4");

// 2. Change the h4 elements
for (let i = 0; i < h4El.length; i++) {
    h4El[i].setAttribute("style", "color:blue", "font-size:30px", "font-weight:bold", "padding-left:10px");
}
